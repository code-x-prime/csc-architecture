...
interface TextProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'children' | 'onClick'> {
  children: ReactNode
  reverse?: boolean
              ...
              {wordObj.characters.map((char, charIndex) => (
                <span className={cn(elementLevelClassName, 'relative whitespace-pre-wrap')} key={charIndex}>
                  <motion.span
                    ...
                    variants={variants}
                    onAnimationComplete={
                      wordIndex === wordObjects.length - 1 && charIndex === wordObj.characters.length - 1 ? onComplete : undefined
                    }
